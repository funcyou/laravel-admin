                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">{{request()->user('admin')->name}}</strong></span>
                                <span class="text-muted text-xs block">{{request()->user('admin')->email}}<b class="caret"></b></span>
                                </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="{{route('admin.user.change_password')}}">修改密码</a>
                            </li>
                            <li class="divider"></li>
                            <li><a href="{{route('admin.auth.logout')}}">安全退出</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="{{route('admin.index.home')}}">首页</a>
                </div>
            </nav>
            ...
            <a href="{{route('admin.auth.logout')}}" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="{{route('admin.index.home')}}" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
    </div>
    <!--右侧部分结束-->
    <!--右侧边栏开始-->
...
<script src="{{asset('hplus/js/hplus.min.js')}}"></script>
